                    ...
                    <div class="col-md-12 column">
                        <table class="table table-bordered">
                            <tr>
                                ...
                                <td><input type="password" name="oldpass" id="oldpass" placeholder="*必填"
                                           autocomplete="off"/></td>
                            </tr>
                            <tr>
                                <td><label for="newpass">新密码</label></td>
                                <td><input type="password" name="newpass" id="newpass" placeholder="*必填"
                                           autocomplete="off"/></td>
                            </tr>
                            <tr>
                                <td><label for="repassword">确认密码</label></td>
                                <td><input type="password" name="repassword" id="repassword" autocomplete="off"
                                           placeholder="确认密码必须与新密码一致" onblur="checkConPwd(this)"/>
                                    <span id="ConPwderr" class="err">密码不一致</span></td>
                            </tr>
                        </table>
                        <div>
                            <input type="submit" id="save" value="保存" class="btn btn-sm btn-info "
