                    ...
                    <div class="col-md-12 column">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td>性别</td>
                                <td>
                                    <input type="radio" name="studentSex"
                                           value="男" ${student.studentSex == '男' ? 'checked':''} /> 男&nbsp;
                                    <input type="radio" name="studentSex"
                                           value="女" ${student.studentSex == '女' ? 'checked':''} /> 女
                                </td>
                            </tr>
                            <tr>
                                <td>出生日期</td>
                                ...
                                <td>
                                    <select name="studentDept" id="studentDept" onchange="change()">
                                        <option value="信息工程学院" ${student.studentDept == '信息工程学院' ? 'selected':''}>
                                            信息工程学院
                                        </option>
                                        <option value="外国语学院" ${student.studentDept == '外国语学院' ? 'selected':''}>
                                            外国语学院
                                        </option>
                                        <option value="商学院" ${student.studentDept == '商学院' ? 'selected':''}>
                                            商学院
                                        </option>
                                        <option value="土木建筑学院" ${student.studentDept == '土木建筑学院' ? 'selected':''}>
                                            土木建筑学院
                                        </option>
                                        <option value="机电工程学院" ${student.studentDept == '机电工程学院' ? 'selected':''}>
                                            机电工程学院
                                        </option>
                                        <option value="艺术设计与传媒学院" ${student.studentDept == '艺术设计与传媒学院' ? 'selected':''}>
                                            艺术设计与传媒学院
                                        </option>
                                        <option value="生物与制药学院" ${student.studentDept == '生物与制药学院' ? 'selected':''}>
                                            生物与制药学院
                                        </option>
                                        <option value="体育学院" ${student.studentDept == '体育学院' ? 'selected':''}>
                                            体育学院
                                        </option>
                                    </select>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="studentMajor" id="studentMajor">
                                        <option value="软件工程" ${student.studentMajor == '软件工程' ? 'selected':''}>
                                            软件工程
                                        </option>
                                        <option value="计算机科学与技术" ${student.studentMajor == '计算机科学与技术' ? 'selected':''}>
                                            计算机科学与技术
                                        </option>
                                        <option value="日语" ${student.studentMajor == '日语' ? 'selected':''}>日语
                                        </option>
                                        <option value="电子商务" ${student.studentMajor == '电子商务' ? 'selected':''}>
                                            电子商务
                                        </option>
                                        <option value="财务管理" ${student.studentMajor == '财务管理' ? 'selected':''}>
                                            财务管理
                                        </option>
                                        <option value="建筑工程" ${student.studentMajor == '建筑工程' ? 'selected':''}>
                                            建筑工程
                                        </option>
                                        <option value="机电工程" ${student.studentMajor == '机电工程' ? 'selected':''}>
                                            机电工程
                                        </option>
                                        <option value="广告设计" ${student.studentMajor == '广告设计' ? 'selected':''}>
                                            广告设计
                                        </option>
                                        <option value="生物技术" ${student.studentMajor == '生物技术' ? 'selected':''}>
                                            生物技术
                                        </option>
                                        <option value="休闲体育" ${student.studentMajor == '休闲体育' ? 'selected':''}>
                                            休闲体育
                                        </option>
                                    </select>
                                </td>
                            ...
                            <tr>
                                <td>电话</td>
                                <td colspan="3"><input type="text" name="studentCellPhone"
                                                       value="${student.studentCellPhone}"/></td>
                            </tr>
                        </table>
                        <div>
                            <input type="submit" name="update" value="提交" class="btn btn-sm btn-info "
                                   style="margin: 0 50px 0 150px;">
                            <a href="${pageContext.request.contextPath}/studentInfo/queryByName"
                               class="btn btn-sm btn-info" style="margin-left: 50px">返回</a>
                        </div>
                    </div>
                </div>
            </div>
